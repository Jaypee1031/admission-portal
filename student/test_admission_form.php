...
<head>
    ...
    <title>Test Admission Form - <?php echo SITE_NAME; ?></title>
    <?php includeFavicon(); ?>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="dashboard-card">
                    ...
                    <p class="text-muted mb-0">This is a simple test form to verify the form display works.</p>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fas fa-save me-2"></i>Test Submit
                            </button>
                        </div>
                    </form>
                </div>
