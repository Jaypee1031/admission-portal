        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="dashboard-card">
                    ...
                    <div class="row">
                        <?php
                        // Get capacity information for upcoming exam slots
                        $upcomingSlots = [];
                        $db = getDB();
                        
                        // Get admin settings for max capacity
                        $stmt = $db->prepare("SELECT setting_value FROM test_permit_settings WHERE setting_key = 'max_permits_per_day'");
                        $stmt->execute();
                        $maxCapacity = $stmt->fetchColumn() ?: 50;
                        
                        // Get upcoming exam slots with capacity info
                        $stmt = $db->prepare("
                            SELECT 
                                exam_date, 
                                exam_time, 
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="card h-100 <?php echo $slot['remaining_slots'] <= 5 ? 'border-warning' : 'border-success'; ?>">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <h6 class="card-title mb-0">
                                            <?php echo date('M d, Y', strtotime($slot['exam_date'])); ?>
                                        </h6>
                                        <span class="badge <?php echo $slot['remaining_slots'] <= 5 ? 'bg-warning' : 'bg-success'; ?>">
                                    ...
                                    <div class="progress mb-2" style="height: 8px;">
                                        <?php 
                                        $percentage = ($slot['current_bookings'] / $slot['max_capacity']) * 100;
                                    ...
                                    <small class="text-muted">
                                        <?php echo $slot['current_bookings']; ?>/<?php echo $slot['max_capacity']; ?> students
                                    </small>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="dashboard-card">
                    ...
                    <?php
                    // Get recent applicants with simple pagination
                    $recentLimit = 10;
                    $recentPage = isset($_GET['recent_page']) && (int)$_GET['recent_page'] > 0 ? (int)$_GET['recent_page'] : 1;
                    $recentOffset = ($recentPage - 1) * $recentLimit;
                    try {
                        $recentResult = $recentApplicantsWidget->getRecentApplicants($recentPage, $recentLimit);
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="progress me-2" style="width: 80px; height: 8px;">
                                                <?php 
                                                $progress = 0;
                                                if ($applicant['requirements_count'] > 0) $progress += 25;
                                                if ($applicant['has_admission_form']) $progress += 25;
                                                if ($applicant['has_test_permit']) $progress += 25;
                                                if ($applicant['has_f2_form'] || $applicant['has_test_results']) $progress += 25;
                                                ?>
                ...
                <div class="dashboard-card">
                    ...
                    <div class="row">
                        <div class="col-md-2 mb-3">
                            <a href="applicants.php?status=Pending" class="btn btn-outline-warning w-100">
                                <i class="fas fa-clock me-2"></i>Review Pending
                            </a>
                        </div>
                        <div class="col-md-2 mb-3">
                            <a href="test_permits.php" class="btn btn-outline-primary w-100">
                                <i class="fas fa-id-card me-2"></i>Test Permits
                            </a>
                        </div>
                        <div class="col-md-2 mb-3">
                            <a href="test_permit_stats.php" class="btn btn-outline-info w-100">
                                <i class="fas fa-chart-bar me-2"></i>Statistics
                            </a>
                        </div>
                        <div class="col-md-2 mb-3">
                            <a href="test_permit_settings.php" class="btn btn-outline-secondary w-100">
                                <i class="fas fa-cog me-2"></i>Settings
                            </a>
                        </div>
                        <div class="col-md-2 mb-3">
                            <a href="applicants.php" class="btn btn-outline-success w-100">
                                <i class="fas fa-users me-2"></i>All Applicants
                            </a>
                        </div>
                        <div class="col-md-2 mb-3">
                            <a href="update_student_statuses.php" class="btn btn-outline-warning w-100">
                                <i class="fas fa-sync-alt me-2"></i>Update Statuses
                            </a>
                        </div>
                        <div class="col-md-2 mb-3">
                            <a href="manage_students.php" class="btn btn-outline-info w-100">
